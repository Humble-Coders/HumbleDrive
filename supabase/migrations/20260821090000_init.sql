-- Humble Drive — initial schema (ticket 1)
--
-- Every rule the product depends on is expressed here as a Postgres
-- constraint. CLAUDE.md rule 1: the database is the enforcement layer and
-- the UI is never. Anything relaxed here silently breaks a guarantee that
